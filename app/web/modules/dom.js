...
export function getDomRefs() {
  return {
    ...
    compareCountBadge: requireElement("compare-count-badge"),
    comparePanel: requireElement("compare-panel"),
    runtimeSelectionCountBadge: requireElement("runtime-selection-count-badge"),
    runtimeSelectionPanel: requireElement("runtime-selection-panel"),
